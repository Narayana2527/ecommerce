...
import footer6 from '../assets/fishImage2.jpg'
      ...
      <div className='p-5 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-2 md:gap-4'>
        ...
        <div className='' >
          ...
          <div className='grid grid-cols-3 gap-1'>
            <div>
              <img src={footer1} className='w-30 h-30' />
              <img src={footer2} className='w-30 h-30' />
              
            </div>
            <div>
              <img src={footer3} className='w-30 h-30' />
              <img src={footer4} className='w-30 h-30' />
            </div>
            <div>
              
              <img src={footer5} className='w-30 h-30' />
              <img src={footer2} className='w-30 h-30' />
            </div>
          </div>
