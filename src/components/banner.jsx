  ...
  return (
    <div className='relative'>
      <div className='relative grid grid-cols-12 md:grid-cols-12 lg:grid-cols-12'>
        <div className=' flex items-center h-[400px] lg:h-[500px] md:h-[500px] md:col-span-8 col-span-full' style={{backgroundImage: 'linear-gradient(to right,#494f19, #011210)'}}>
